...
{{- else -}}
error: {{ printf "4. No secret found with prefix '%s' and label 'sealedsecrets.bitnami.com/sealed-secrets-key: active' in namespace '%s'" $desiredPrefix $namespace  | quote }}
{{- end -}}
{{- end -}}
